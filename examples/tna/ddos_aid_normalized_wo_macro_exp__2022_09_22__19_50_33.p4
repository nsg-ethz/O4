...
parser MyIngressParser(packet_inpkt, out my_ingress_headers_thdr,  out my_ingress_metadata_t meta,  out ingress_intrinsic_metadata_tig_intr_md, out ingress_intrinsic_metadata_for_tm_t ig_tm_md) {
...
control MyIngress( inout my_ingress_headers_t hdr, inout my_ingress_metadata_tmeta, iningress_intrinsic_metadata_t ig_intr_md, iningress_intrinsic_metadata_from_parser_t ig_prsr_md, inout ingress_intrinsic_metadata_for_deparser_tig_dprsr_md, inout ingress_intrinsic_metadata_for_tm_tig_tm_md) { 
...
meta.cluster1_dst3_distance = distance_cluster1_dst3_max.execute(port);
    ...
    @pragma stage 0 table tbl_compute_distance_cluster1_sport_min {
        key = {
...
const default_action = NoAction();
    ...
    @pragma stage 4 table tbl_compute_distance_cluster1_sport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 1 table tbl_compute_distance_cluster1_dst2_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 5 table tbl_compute_distance_cluster1_dst2_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 2 table tbl_compute_distance_cluster1_dport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 6 table tbl_compute_distance_cluster1_dport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 3 table tbl_compute_distance_cluster1_dst3_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 7 table tbl_compute_distance_cluster1_dst3_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
meta.cluster2_dst3_distance = distance_cluster2_dst3_max.execute(port);
    ...
    @pragma stage 0 table tbl_compute_distance_cluster2_sport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 4 table tbl_compute_distance_cluster2_sport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 1 table tbl_compute_distance_cluster2_dst2_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 5 table tbl_compute_distance_cluster2_dst2_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 2 table tbl_compute_distance_cluster2_dport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 6 table tbl_compute_distance_cluster2_dport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 3 table tbl_compute_distance_cluster2_dst3_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 7 table tbl_compute_distance_cluster2_dst3_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
meta.cluster3_dst3_distance = distance_cluster3_dst3_max.execute(port);
    ...
    @pragma stage 0 table tbl_compute_distance_cluster3_sport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 4 table tbl_compute_distance_cluster3_sport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 1 table tbl_compute_distance_cluster3_dst2_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 5 table tbl_compute_distance_cluster3_dst2_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 2 table tbl_compute_distance_cluster3_dport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 6 table tbl_compute_distance_cluster3_dport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 3 table tbl_compute_distance_cluster3_dst3_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 7 table tbl_compute_distance_cluster3_dst3_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
meta.cluster4_dst3_distance = distance_cluster4_dst3_max.execute(port);
    ...
    @pragma stage 0 table tbl_compute_distance_cluster4_sport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 4 table tbl_compute_distance_cluster4_sport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 1 table tbl_compute_distance_cluster4_dst2_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 5 table tbl_compute_distance_cluster4_dst2_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 2 table tbl_compute_distance_cluster4_dport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 6 table tbl_compute_distance_cluster4_dport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 3 table tbl_compute_distance_cluster4_dst3_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 7 table tbl_compute_distance_cluster4_dst3_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
update_cluster1_dst3_max.execute(port);
    ...
    @pragma stage 0 table tbl_do_update_cluster1_sport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 4 table tbl_do_update_cluster1_sport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 1 table tbl_do_update_cluster1_dst2_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 5 table tbl_do_update_cluster1_dst2_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 2 table tbl_do_update_cluster1_dport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 6 table tbl_do_update_cluster1_dport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 3 table tbl_do_update_cluster1_dst3_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 7 table tbl_do_update_cluster1_dst3_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
update_cluster2_dst3_max.execute(port);
    ...
    @pragma stage 0 table tbl_do_update_cluster2_sport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 4 table tbl_do_update_cluster2_sport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 1 table tbl_do_update_cluster2_dst2_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 5 table tbl_do_update_cluster2_dst2_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 2 table tbl_do_update_cluster2_dport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 6 table tbl_do_update_cluster2_dport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 3 table tbl_do_update_cluster2_dst3_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 7 table tbl_do_update_cluster2_dst3_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
update_cluster3_dst3_max.execute(port);
    ...
    @pragma stage 0 table tbl_do_update_cluster3_sport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 4 table tbl_do_update_cluster3_sport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 1 table tbl_do_update_cluster3_dst2_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 5 table tbl_do_update_cluster3_dst2_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 2 table tbl_do_update_cluster3_dport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 6 table tbl_do_update_cluster3_dport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 3 table tbl_do_update_cluster3_dst3_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 7 table tbl_do_update_cluster3_dst3_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
update_cluster4_dst3_max.execute(port);
    ...
    @pragma stage 0 table tbl_do_update_cluster4_sport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 4 table tbl_do_update_cluster4_sport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 1 table tbl_do_update_cluster4_dst2_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 5 table tbl_do_update_cluster4_dst2_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 2 table tbl_do_update_cluster4_dport_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 6 table tbl_do_update_cluster4_dport_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 3 table tbl_do_update_cluster4_dst3_min {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
const default_action = NoAction();
    ...
    @pragma stage 7 table tbl_do_update_cluster4_dst3_max {
        key = {
            ig_tm_md.ucast_egress_port : exact;
        }
        actions = {
...
control MyIngressDeparser(packet_out pkt, inout my_ingress_headers_t hdr, inmy_ingress_metadata_tmeta, iningress_intrinsic_metadata_for_deparser_tig_dprsr_md) {
...
parser MyEgressParser(packet_inpkt, out my_egress_headers_thdr, out my_egress_metadata_t meta, out egress_intrinsic_metadata_teg_intr_md) {
...
control MyEgress( inout my_egress_headers_thdr, inout my_egress_metadata_t meta, inegress_intrinsic_metadata_teg_intr_md, inegress_intrinsic_metadata_from_parser_teg_prsr_md, inout egress_intrinsic_metadata_for_deparser_t eg_dprsr_md, inout egress_intrinsic_metadata_for_output_port_teg_dport_md) {
...
control MyEgressDeparser(packet_out pkt, inout my_egress_headers_t hdr,  inmy_egress_metadata_tmeta, inegress_intrinsic_metadata_for_deparser_teg_dprsr_md) {
...
MyEgressParser(), MyEgress(), MyEgressDeparser()  ) pipe;
