...
control MyIngress(inout headers hdr,
    ...
    action _update_bloom_filter(){
       ...
       hash(meta.output_hash_one, HashAlgorithm.crc32_custom, (bit<16>)0, {hdr.ipv4.srcAddr,
                                                          hdr.ipv4.dstAddr,
                                                          hdr.tcp.srcPort,
                                                          hdr.tcp.dstPort,
                                                          hdr.ipv4.protocol},
       ...
       hash(meta.output_hash_two, HashAlgorithm.crc32_custom, (bit<16>)0, {hdr.ipv4.srcAddr,
                                                          hdr.ipv4.dstAddr,
                                                          hdr.tcp.srcPort,
                                                          hdr.tcp.dstPort,
                                                          hdr.ipv4.protocol},
