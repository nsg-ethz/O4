...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    register<bit<64>>(2048) um_ip_src;
    register<bit<64>>(2048) um_ip_dst;
    register<bit<64>>(2048) um_ports_proto_id;
    register<bit<64>>(2048) um_counter;
    register<bit<64>>(2048) dm_ip_src;
    register<bit<64>>(2048) dm_ip_dst;
    register<bit<64>>(2048) dm_ports_proto_id;
    register<bit<64>>(2048) dm_counter;
    action drop() {
        mark_to_drop(standard_metadata);
    }
    action compute_hash_indexes() {
        hash(meta.um_h1, HashAlgorithm.crc32_custom, meta.batch_id * 2048 / 2 + ((bit<16>)standard_metadata.egress_spec - 1) * 2048 / 2 / 2, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, meta.tmp_src_port, meta.tmp_dst_port, hdr.loss.nextProtocol, hdr.ipv4.identification }, (bit<16>)2048 / 2 / 2);
        hash(meta.um_h2, HashAlgorithm.crc32_custom, meta.batch_id * 2048 / 2 + ((bit<16>)standard_metadata.egress_spec - 1) * 2048 / 2 / 2, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, meta.tmp_src_port, meta.tmp_dst_port, hdr.loss.nextProtocol, hdr.ipv4.identification }, (bit<16>)2048 / 2 / 2);
        hash(meta.um_h3, HashAlgorithm.crc32_custom, meta.batch_id * 2048 / 2 + ((bit<16>)standard_metadata.egress_spec - 1) * 2048 / 2 / 2, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, meta.tmp_src_port, meta.tmp_dst_port, hdr.loss.nextProtocol, hdr.ipv4.identification }, (bit<16>)2048 / 2 / 2);
        hash(meta.dm_h1, HashAlgorithm.crc32_custom, meta.previous_batch_id * 2048 / 2 + ((bit<16>)standard_metadata.ingress_port - 1) * 2048 / 2 / 2, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, meta.tmp_src_port, meta.tmp_dst_port, hdr.loss.nextProtocol, hdr.ipv4.identification }, (bit<16>)2048 / 2 / 2);
        hash(meta.dm_h2, HashAlgorithm.crc32_custom, meta.previous_batch_id * 2048 / 2 + ((bit<16>)standard_metadata.ingress_port - 1) * 2048 / 2 / 2, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, meta.tmp_src_port, meta.tmp_dst_port, hdr.loss.nextProtocol, hdr.ipv4.identification }, (bit<16>)2048 / 2 / 2);
        hash(meta.dm_h3, HashAlgorithm.crc32_custom, meta.previous_batch_id * 2048 / 2 + ((bit<16>)standard_metadata.ingress_port - 1) * 2048 / 2 / 2, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, meta.tmp_src_port, meta.tmp_dst_port, hdr.loss.nextProtocol, hdr.ipv4.identification }, (bit<16>)2048 / 2 / 2);
    }
