...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action _update_bloom_filter() {
        hash(meta.output_hash_one, HashAlgorithm.crc32_custom, (bit<16>)0, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.ipv4.protocol }, (bit<32>)4096);
        hash(meta.output_hash_two, HashAlgorithm.crc32_custom, (bit<16>)0, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.ipv4.protocol }, (bit<32>)4096);
    ...
    apply {
        if (hdr.ipv4.isValid()) {
            if (hdr.tcp.isValid()) {
                ...
                if (meta.counter_one > 1000 && meta.counter_two > 1000) {
                    drop_table.apply();
                    return;
                }
            }
